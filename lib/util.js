...
module.exports.str = {
    startsWith: function(input, text) {
        return module.exports.nil(input) 
            ? false
            : input.slice(0, text.length) === text;
    }
  , endsWith: function(input, text) {
        return module.exports.nil(input)
            ? false
            : input.slice(-text.length) === text;
    }
};
 ...
 */
module.exports.toHash = function(arr, toStrFn, toValFn, addFn) {
    var hash  = {}
      , obj   = null
      , key   = null
      , i     = 0
