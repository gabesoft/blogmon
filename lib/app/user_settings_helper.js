var util     = require('../util.js')
  ...
  , setUnread = function(repo, id, value, callback) {
        repo.set({
            type  : 'post'
          , name  : 'unread'
          , id    : id
...
UserSettingsHelper.prototype.setPostRead = function(post, callback) {
    setUnread(this.repo, post, false, callback);
};

UserSettingsHelper.prototype.setPostUnread = function(post, callback) {
    setUnread(this.repo, post, true, callback);
};
